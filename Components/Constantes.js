...
export default function Constantes({route , navigation}) {
  
    let [loading, setLoading] = useState(true);
    const [ticketValue , setTicketValue] = useState('');
    const [patientEmail , setPatientEmail] = useState('');
    const [age , setAge] = useState('');
    const [statut_vaccinal , setStatutVaccinal] = useState('');
    ...
    const handleTaille = (text)=>{
        setTaille(text);
    }


    const handlePoids = (text)=>{
        setPoids(text);
    }

    const handleTension = (text)=>{
        setTension(text);
    }
    ...
    const handleStatutVaccinal = (text)=>{
       setStatutVaccinal(text);
    }
    ...
    const AddConsultation =  ()=>{
        ...
        fetch(`${globalConst.hostUrl}/api/doconstanteconsult`, {
            method: 'POST',
            headers: {
              'Accept':'application/json',
              'Content-Type':'application/json'
            ...
            body:JSON.stringify({
                ...
                infirmier_email:route.params.docEmail,
                date:date,
                ...
                tension:tension, 
                age:age, 
                statut_vaccinal:statut_vaccinal
            }) 
  ...
  return (
       ...
       >
            ...
            <View   style={{  display:'flex', justifyContent:'center', alignItems:'center'}}>
                ...
                <TextInput onChangeText={handleTaille} placeholder="Taille du patient" multiline={true} style={Styles.textinputtwo}/>
                <TextInput onChangeText={handleTension} placeholder="Tension du patient" multiline={true} style={Styles.textinputtwo}/>
                <TextInput onChangeText={handlePoids} placeholder="Poids du patient " multiline={true} style={Styles.textinputtwo}/>
                <TextInput onChangeText={handleAge} placeholder="Age" multiline={true} style={Styles.textinputtwo}/>
                <TextInput onChangeText={handleStatutVaccinal} placeholder="Statut vaccinal" multiline={true} style={Styles.textinputtwo}/>
